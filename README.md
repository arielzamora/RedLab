...
*   **[ADR 0017 - Uso de Gráficos SVG Nativos en Angular para el Dashboard de Estadísticas](file:///C:/Repos/Progra4-2026/red-social/docs/adr/0017-uso-graficos-svg-nativos-dashboard.md)**: Adopción de gráficos vectoriales directos en Angular para evitar incompatibilidades de paquetes de terceros.
*   **[ADR 0018 - Registro y Gestión de Usuarios por Administradores (Alta y Baja Lógica)](file:///C:/Repos/Progra4-2026/red-social/docs/adr/0018-registro-y-gestion-usuarios-administracion.md)**: Implementación de control administrativo de usuarios con alta/baja lógica y bloqueo proactivo al inicio de sesión.
